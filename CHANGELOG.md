...
* (evm) [#443](https://github.com/crypto-org-chain/ethermint/pull/443) Keep behavior of random opcode as before.
...
* (evm) [#499](https://github.com/crypto-org-chain/ethermint/pull/499) Use hash of block timestamp for random opcode.
